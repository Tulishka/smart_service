def test_create_ticket(client, auth_apikey):
    ...
    user_response = client.post("/api/v1/users", json=user_data, params=auth_apikey)
    ...
    asset_response = client.post("/api/v1/assets", json=asset_data, params=auth_apikey)
...
def test_get_ticket(client, auth_apikey):
    ...
    create_response = client.post("/api/v1/tickets", json=ticket_data, params=auth_apikey)
    ticket_id = create_response.json["id"]

    response = client.get(f"/api/v1/tickets/{ticket_id}", params=auth_apikey)
...
def test_delete_ticket(client, auth_apikey):
    ...
    response = client.delete(f"/api/v1/tickets/{ticket_id}", params=auth_apikey)
